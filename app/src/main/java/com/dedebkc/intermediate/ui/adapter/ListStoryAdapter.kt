package com.dedebkc.intermediate.ui.adapter
...
import com.dedebkc.intermediate.databinding.ItemRowStoryBinding
import com.dedebkc.intermediate.model.StoryModel
import com.dedebkc.intermediate.ui.mainmenu.home.HomeFragmentDirections
import com.dedebkc.intermediate.utils.DiffUtilCallback
...
class ListStoryAdapter : PagingDataAdapter<StoryModel, ListStoryAdapter.ListViewHolder>(DiffUtilCallback()) {
    inner class ListViewHolder(binding: ItemRowStoryBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        var detail = binding.tvDetailDescription
